...
export default function NavBar() {
  ...
  return (
    <nav className='w-[8vw] max-w-28 h-screen min-h-96 flex flex-col gap-12 items-start justify-between overflow-hidden'>
      <Link
        href='/'
      ...
      <div className='flex flex-col -translate-x-2'>
        ...
        <Link
          href='/about'
          className={clsx(
            'link-anim relative mr-2 -translate-y-8',
